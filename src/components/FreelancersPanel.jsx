...
import { collaboratorsService } from '@/lib/supabaseHelpers';
...
export default function FreelancersPanel() {
  ...
  const loadCollaborators = async () => {
    setLoading(true);
    try {
      const data = await collaboratorsService.getAll(true); // Fetch all collaborators
    ...
    switch (type) {
      case 'interno':
        return {
          ...
          description: 'Salario fijo semanal'
        };
      case 'freelancer':
        return {
          label: 'Freelancer',
          ...
          description: 'Pago por actividad'
        };
      default:
        return {
          label: 'Freelancer',
  ...
  const getProfilePhoto = (collaborator) => {
    if (collaborator.profile_photo_url) {
      return collaborator.profile_photo_url;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-blue-700 text-sm">
          Activa o desactiva colaboradores para controlar su visibilidad en las listas de asignación de tareas. Los colaboradores inactivos no se pueden asignar a nuevos proyectos.
        </p>
      </div>
